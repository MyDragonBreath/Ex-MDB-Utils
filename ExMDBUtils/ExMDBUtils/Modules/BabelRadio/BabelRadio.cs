...
namespace ExMDBUtils.Modules
{
    ...
    public class BabelRadio : BaseModule
    {
        ...
        public override void Enable(Plugin _plugin)
        {
            ...
            pv.RadioToScp = new CustomVoiceChannel(new int[] { -1 }, VoiceChat.VoiceChatChannel.Radio, new int[] { }, VoiceChat.VoiceChatChannel.ScpChat, Plugin.Singleton.Config.BabelRadio.IsAnonymous);
            pv.Register();
        }
    }
}
